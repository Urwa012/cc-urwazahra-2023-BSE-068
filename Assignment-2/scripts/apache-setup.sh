...
# Use server name passed by Terraform, fallback to default
SERVER_NAME=${SERVER_NAME:-myapp-webserver}
...
<body>
    <div class="container">
        ...
        <div class="info"><span class="label">Server:</span> $SERVER_NAME</div>
...
echo "Apache setup completed successfully for $SERVER_NAME!"
